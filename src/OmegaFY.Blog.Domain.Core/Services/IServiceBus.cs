...
namespace OmegaFY.Blog.Domain.Core.Services
{
    ...
    public interface IServiceBus
    {
        ...
        public Task<TResult> SendMessageAsync<TRequest, TResult>(TRequest command, CancellationToken cancellationToken) 
            where TRequest : IRequestInput where TResult : IResult;
